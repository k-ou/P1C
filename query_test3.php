...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<!--end ADD NEW dropdown-->
        <li data-tab="movieDBQuery"><a href="#">Browse</a></li>
	<!--dropdown-->
        <li class="dropdown">
...
<div class="tab-content movieDBQuery">

<h1>Movie Database Query</h1>
<p>(Ver 1.0 10/21/2015 by Sharon Grewal and Kelly Ou)<br>
...
print "Results from MySQL: <br />";

if (!sizeof($print_array)) {
...
$query = sprintf("INSERT INTO position VALUES (id, firstName, lastName, sex, dob, dod)",
